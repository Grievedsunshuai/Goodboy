...
<div class="block-area" id="text-input">
    ...
    <div class="row">
        <form action='/admin1/auser/{{ $ob->Auser_id }}' method='post'>
            ...
            <div class="col-lg-4">
                用户名：
                    <input type="text" class="form-control m-b-10" placeholder="请输入账号" name='Auser_name' value="{{ $ob->Auser_name }}">
            </div>
            <div class="col-lg-4">
                年龄：
                    <input type="text" class="form-control m-b-10" placeholder="请输入年龄" name='Auser_age' value="{{ $ob->Auser_age }}">
            </div>
            <div class="col-lg-4">
