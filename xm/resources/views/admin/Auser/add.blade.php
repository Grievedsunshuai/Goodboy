...
<div class="block-area" id="text-input">
    ...
    @endif
    <div class="row">
        <form action='/admin1/auser' method='post'>
            {{ csrf_field() }}
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <input type="text" class="form-control m-b-10" placeholder="请输入年龄" name='Auser_age'>
            </div>
            <div class="col-lg-6">
                <select class="form-control m-b-10" name='Auser_sex'>
                    <option>--请选择性别--</option>
