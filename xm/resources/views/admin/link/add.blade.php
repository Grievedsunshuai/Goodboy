 ...
 <div class="block-area" id="text-input">
    ...
    {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-4">
                链接文字:
                <input name='Links_name' type="text" class="form-control m-b-10" placeholder="请输入链接文字">
            </div>
            <div class="col-lg-4">
               URL地址:
                <input type="text" name='Links_url' class="form-control m-b-10" placeholder="请输入链接地址">
            </div>
            <div class="col-lg-4">
                链接开关:
