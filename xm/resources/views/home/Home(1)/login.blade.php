        ...
        <div class="layout_panel">
          <div class="layout" id="layout">
            ...
            <div class="mainbox" id="login-main">
                    ...
                    <form action="/home1/dologin" method="POST" id="login-main-form">
                      ...
                      <div class="loginbox c_b">
                        ...
                        <div class="security_Controller" style="display: none;">
                          <label class="checkbox_area"><input id="trustSecurityController" class="checkbox" type="checkbox">使用安全控件</label>
                        </div>
              ...
              <div class="tabs-con tabs_con" data-con="qr" style="display: none;">
                <div class="tab_qrcon">
                  <div class="tab_code_iframe">
                    <iframe style="background:#fff;" src="{{ asset('Home/login/img/a_002.htm')  }}" id="tab-qriframe" scrolling="no" frameborder="0" height="180" width="180"></iframe>
                  </div>
